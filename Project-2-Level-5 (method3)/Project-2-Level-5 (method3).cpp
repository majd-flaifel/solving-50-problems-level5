...
string GetNameOfOpType(enOperationType OperationType) {
 ...
 void CheckPlayerResult(stTestResult& TestResult) {
 ...
 string GetFinalResultText(bool FinalResult) {
...
void Print_FinalResult(stTestResult TestResult) {
    CheckPlayerResult(TestResult);
    cout << "\n------------------------------\n";
    cout << "Final Result is " << GetFinalResultText(TestResult.IsPass);
    cout << "\n------------------------------\n\n";
