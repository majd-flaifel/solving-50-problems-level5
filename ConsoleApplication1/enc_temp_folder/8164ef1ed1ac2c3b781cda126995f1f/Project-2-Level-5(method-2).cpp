...
short ReadHowManyQuestion()
{
	...
	do
	{
		cout << "Kindly enter How many qusetions you want to test ( 1 to 10 ) ";
		cin >> Questions;
...
enQuestionLevel ReadQuestionLevel()
{
	...
	do
	{
		cout << "Kindly enter your Questions Level ([1] Easy, [2] Mid, [3] Hard , [4] MixOp)  ";
		cin >> QuestionLevel;
...
enOperationType ReadOpType()
{
	...
	do
	{
		cout << "Kindly enter Operation Type ( [1] Add, [2] Sub, [3] Multi , [4] Divide , [5] Mix) ";
		cin >> OpType;
