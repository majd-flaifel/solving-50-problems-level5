...
float AverageOfAllNumbersInArray( int arr[100], int NumberOfElements) {
	
	return 	float(SumOfAllNumbersInArray(arr, NumberOfElements)) / NumberOfElements;
...
int main()
{
	...
	cout << "Average Of All Numbers is : " << AverageOfAllNumbersInArray(arr,NumberOfElements) << endl;
}