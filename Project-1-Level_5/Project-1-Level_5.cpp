...
void Print_FinalResult(int countRounds, int playerwon, int computerwon, int draw) {
...
void AskUserMoreTours(int number, int& CountRounds, int playerChoice, int computerChoice, int& playerwon, int& computerwon, int& draw) {
    char playmore;
    ...
    while (playmore == 'y') {
        ...
        Print_EachRound(Read_RoundTimes(), CountRounds, playerChoice, computerChoice, playerwon, computerwon, draw);
        Print_FinalResult(CountRounds , playerwon, computerwon, draw);
        cout << "Do you want to play again? Y/N ?";
        cin >> playmore;
...
int main()
{
    ...
    Print_FinalResult(CountRounds-1, playerwon, computerwon, draw);
    AskUserMoreTours(numberofrounds, CountRounds, PlayerChoice, ComputerChoice, playerwon, computerwon, draw);
}
