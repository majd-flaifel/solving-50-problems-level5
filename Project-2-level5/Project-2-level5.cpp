...
string OperationType(enOperationType OperationType) {

    string ArrenOperationType[5] = { "Add" , "Sub", "Mul", "Div", "MixOp" };
    return ArrenOperationType[OperationType - 1];
}
void Print_FinalResult(stTestResult TestResult, stTestInfo TestInfo) {
    ...
    cout << "Qestions Level:" << QuestionsLevel(TestInfo.QuestionsLevel) << endl;
    cout << "OpType: " << OperationType(TestInfo.OperationType) << endl;
    cout << "Number Of Right Answers: " << TestResult.NumberOfRightQuestions << endl;
    cout << "Number Of Wrong Answers: " << TestResult.NumberOfWrongQuestions << endl << endl;
    cout << "\n------------------------------\n";
}
void ResetScreen() {
    system("cls");
...
void StartGame() {
    ...
    do {
        ...
        ResetScreen();
        NumberOfQuestions = Read_NumberOfQuestions();
        AskUserAboutTestStyle(TestInfo);

        StartTest(NumberOfQuestions, TestResult, TestInfo);
